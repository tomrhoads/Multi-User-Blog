...
class BlogFront(BlogHandler):
    def get(self):
        ...
        if posts:
            ...
            self.render('firstpostpage.html')
...
class NewPost(BlogHandler):
    def get(self):
        if self.user:
            ...
            self.write("You must be logged in to create a new post")
            self.redirect("/login")
...
class NewComment(BlogHandler):
    def get(self, post_id):
        ...
        self.render("newcomment.html", subject=subject, content=content, postkey=post.key())
...
class CommentError(BlogHandler):
    def get(self):
        self.write('There was an error with your comment')
